...
extension Color {
    ...
    struct MessageBoxCustomColorSet {
        ...
        public let infoProgressBackground       = Color("color MessageBox Info Progress Background")
        ...
        public let okProgressBackground         = Color("color MessageBox Ok Progress Background")
        ...
        public let warningProgressBackground    = Color("color MessageBox Warning Progress Background")
        ...
        public let errorProgressBackground      = Color("color MessageBox Error Progress Background")
    }
